...
<!----start-img-cursual---->
	<div id="owl-demo" class="owl-carousel">
		<div class="item" onclick="location.href='details.html';">
			...
			<div class="cau_left">
				<h4><a href="new/details.html">branded shoes</a></h4>
				<a href="new/details.html" class="btn">shop</a>
			</div>
		</div>	
		<div class="item" onclick="location.href='new/details.html';">
			<div class="cau_left">
				<img class="lazyOwl" data-src="template/images/c2.jpg" alt="Lazy Owl Image">
			</div>
			<div class="cau_left">
				<h4><a href="new/details.html">branded tees</a></h4>
				<a href="new/details.html" class="btn">shop</a>
			</div>
		</div>	
		<div class="item" onclick="location.href='new/details.html';">
			...
			<div class="cau_left">
				<h4><a href="new/details.html">branded jeens</a></h4>
				<a href="new/details.html" class="btn">shop</a>
			</div>
		</div>	
		<div class="item" onclick="location.href='new/details.html';">
